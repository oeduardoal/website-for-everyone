  ...
  <>
    ...
    >
      ...
      <Text size="bodyLargeStandard" color="$light-light">
        ...
        <br />
        <br />
        Assumimos o compromisso de evoluir e promover uma experiência simples e
        inclusiva para todos. Para assegurar uma boa navegação, temos tradução
        do conteúdo do site para libras, suporte para navegação por teclado,
        além de ajustes de fonte e contraste.
      </Text>
    </Container>
    <Container
      css={{
    ...
    >
      ...
      <Card>
        ...
        <Text size="bodyMediumStandard" color="$medium-light-1">
          Quando encontrar o ícone de Libras em alguma de nossas páginas, basta
          clicar e visualizar a tradução do conteúdo por um intérprete humano de
          Libras.
        </Text>
      </Card>
      <Card>
      ...
      <Card>
        ...
        <Text size="bodyMediumStandard" color="$medium-light-1">
          No nosso site, seguimos as Diretrizes de Acessibilidade de Conteúdo de
          Website (WCAG) 2.0, o que significa que mantemos o conteúdo amigável
          para leitores de tela, navegação por teclado, além de outras
          adaptações para facilitar o acesso para todas as pessoas.
        </Text>
      </Card>
    </Container>
    <Separator />
    ...
    >
      ...
      <Card>
        ...
        <Text size="bodyMediumStandard" color="$medium-light-1">
          ...
          compreendida por todas as pessoas. Para isso, contamos com o apoio de
          intérpretes de Libras em eventos internos e externos, além das
          legendas e descrição de aspectos visuais.
        </Text>
      ...
      <Card>
        ...
        <Text size="bodyMediumStandard" color="$medium-light-1">
          O Inclusão na Real é nosso grupo de afinidades que atua para despertar
          o potencial de todas as pessoas e garantir a acessibilidade. Dessa
          forma, viabiliza que colaboradores que são pessoas com deficiência
          sintam-se incluídas no Grupo Boticário.
        </Text>
      ...
      <Card>
        ...
        <Text size="bodyMediumStandard" color="$medium-light-1">
          Canal no Youtube com vídeos de maquiagem com audiodescrição, legendas
          e tradução em libras inspirado nas dúvidas mais populares da internet.
          Makes, técnicas, produtos e truques mais comentados se transformam em
          tutoriais e dicas.
        </Text>
      ...
      <Card>
        ...
        <Text size="bodyMediumStandard" color="$medium-light-1">
          Pessoas com deficiência visual não conseguem diferenciar produtos com
          embalagens iguais, o que, infelizmente, ainda é um problema comum em
          nosso portfólio. Para resolver isso, criamos para todas as marcas as
          etiquetas sensoriais, adesivos em relevo que podem ser colados nos
          produtos, permitindo diferenciação entre os itens e simplificando o
          uso cotidiano.
        </Text>
    ...
    >
      ...
      <Button variant="alt">Conheça nossas vagas</Button>
      <Button variant="alt">Seja Representante</Button>
    </Container>
    <Container css={{ paddingTop: '$7', paddingBottom: '$7', gap: '$3' }}>
