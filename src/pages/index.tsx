      ...
      <Flex css={{ flexWrap: 'wrap', gap: '$4', justifyContent: 'flex-end' }}>
        ...
        <Card>
          ...
          <Text size="bodyMediumStandard" color="$medium-light-1">
            ...
            outras adaptações para facilitar o acesso para todas as pessoas.
          </Text>
        </Card>
      </Flex>
    </Container>
      ...
      <Flex css={{ flexWrap: 'wrap', gap: '$4', justifyContent: 'flex-end' }}>
        ...
        <Card>
          ...
          <Text size="bodyMediumStandard" color="$medium-light-1">
            ...
            transformam em tutoriais e dicas.
          </Text>
        ...
        <Card>
          ...
          <Text size="bodyMediumStandard" color="$medium-light-1">
            ...
            marcas as etiquetas sensoriais, adesivos em relevo que podem ser
            colados nos produtos, permitindo diferenciação entre os itens e
            simplificando o uso cotidiano.
          </Text>
